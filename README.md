...
### クイズアプリ
- **200問の問題** - 8カテゴリを網羅的に収録
- **カテゴリ・難易度別学習** - カテゴリと難易度（初級/中級/上級）でフィルタリング
...
- **復習モード** - 間違えた問題だけを出題
- **問題一覧** - 全問題を一覧表示、問題ごとの正答率を確認、単問練習
...
`quiz-app/data/questions.json` を編集して問題を追加できます（現在200問収録、id 1-200）。
...
| explanation | 解説文 |
| difficulty | 難易度（1=初級, 2=中級, 3=上級）※省略時は中級 |
| source | 出典情報（下記参照） |
